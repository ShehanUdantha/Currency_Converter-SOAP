...
public class WS
{
    ...
    public Float converter(String sourceCurrency, String targetCurrency, float amountInSourceCurrency){
        ...
        float getSourceCurrency = JsonParser(sourceCurrency);
        float getTargetCurrency = JsonParser(targetCurrency);

        System.out.println("source currency value " + getSourceCurrency);
        System.out.println("target currency value " + getTargetCurrency);
        System.out.println("amount of source currency " + amountInSourceCurrency);
